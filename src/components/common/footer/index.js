...
const Footer = () => {
    ...
    return (
        <Footerc>
            <Footers>
        <h1 className="letter3">Contact Us</h1><br/><br/>
        <p className="letter2">Join Our Restaurant for newsletter to receive our best promotions</p>
        <p className="letter2">You can unsubscribe at any time</p><br/>
            <Inputareas>
                ...
                <FooterL>
                    <FooterLW>
                        <FooterLI>
                            <h2 className="footer-link-items letter3">About Us</h2><br/>
                        ...
                        <FooterLI>
                            <h2 className="footer-link-items letter3">Contact Us</h2><br/>
                        ...
                        <FooterLI>
                            <h2 className="footer-link-items letter3">Videos</h2><br/>
                        ...
                        <FooterLI>
                            <h2 className="footer-link-items letter3">Social Media</h2><br/>
                ...
                <SocialM>
                    <SocialMW>                        
                         <Link className="social-logo letter3">
                            Social Networks&nbsp;                    
                         </Link>
                    </SocialMW>
